...
{
  internal class EditOperationRedo : Button
  {
    protected override async void OnClick()
    {
      ...
      if (opManager != null)
      {
        ...
        if (opManager.CanRedo)
          await opManager.RedoAsync(1, "Editing");
      }
    }
    ...
    protected override void OnUpdate()
    {
      ...
      bool criteria = false;  //criteria for disabled 
      ...
      else
      {
        ...
        if (criteria)
          this.DisabledTooltip = "No edits to redo.";
      }
    }
